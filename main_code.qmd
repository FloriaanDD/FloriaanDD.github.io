...
There are many good software available to estimate relatedness, such as COLONY2, sequoia, gcta64, etc. For this example, we use the `related` package @pew_related.
