...
::: callout-tip
Below is a table modified from @speed2015_relatedness showing kinship values, and their confidence intervals (CI) for different relationships.
...
There are many good software available to estimate relatedness, such as COLONY2, sequoia, gcta64, EMIBD9, etc. For this example, we use the `related` package @pew_related.
